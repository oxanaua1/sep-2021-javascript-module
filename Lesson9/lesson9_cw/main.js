...
// for (const simpson of simpsons) {
//     divSimpson = document.createElement('div');
//     h3Simpson = document.createElement('h3');
//     imgSimpson = document.createElement('img');
//     pSimpson = document.createElement('p');
//
//     document.body.appendChild(divSimpson);
//     divSimpson.appendChild(h3Simpson);
//     divSimpson.appendChild(imgSimpson);
//     divSimpson.appendChild(pSimpson);
//
//     divSimpson.classList.add('member');
//     divSimpson.style.display = "flex"
//     imgSimpson.style.width = "30%"
//
//     h3Simpson.innerText = simpson.name + " " + simpson.surname;
//     imgSimpson.src = simpson.photo;
//     pSimpson.innerText = `Age - ${simpson.age}; ${simpson.info}`;
//
//
//     console.log(divSimpson);
//     console.log(h3Simpson);
//     console.log(imgSimpson);
//     console.log(pSimpson);
//
// }
//
...
for (const course of coursesArray) {
    ...
    for (let moduleElement of course.modules) {
       let liModuls = document.createElement('li');
        ulModules.appendChild(liModuls);
        liModuls.innerText = moduleElement;
